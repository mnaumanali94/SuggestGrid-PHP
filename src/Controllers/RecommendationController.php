...
class RecommendationController extends BaseController {
    ...
    /**
     * @var RecommendationController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return RecommendationController The *Singleton* instance.
     */
     ...
     * @param  Models\GetRecommendedUsersBody $query     Required parameter: The query for recommended users.
                ...
                $query) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/v1/recommend/users';
     ...
     * @param  Models\GetRecommendedItemsBody $query     Required parameter: The query for recommended items.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $query) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/v1/recommend/items';
